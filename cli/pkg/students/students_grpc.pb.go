...
type RegistrationClient interface {
	AddStudent(ctx context.Context, in *Student, opts ...grpc.CallOption) (*Decision, error)
}
...
func (c *registrationClient) AddStudent(ctx context.Context, in *Student, opts ...grpc.CallOption) (*Decision, error) {
	out := new(Decision)
	err := c.cc.Invoke(ctx, "/students.registration/AddStudent", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RegistrationServer interface {
	AddStudent(context.Context, *Student) (*Decision, error)
...
func (UnimplementedRegistrationServer) AddStudent(context.Context, *Student) (*Decision, error) {
...
func _Registration_AddStudent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Student)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RegistrationServer).AddStudent(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/students.registration/AddStudent",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RegistrationServer).AddStudent(ctx, req.(*Student))
	}
...
var Registration_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "students.registration",
	HandlerType: (*RegistrationServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "AddStudent",
			Handler:    _Registration_AddStudent_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "pkg/students/students.proto",
}
